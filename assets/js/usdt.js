...
// Wallet edit
const usdtName = localStorage.getItem("usdtName") || "USDT";
const usdtDiscription =
  localStorage.getItem("usdtDiscription") ||
  "Please copy the address to clipboard to avoid sending to the wrong address.";
const usdtAddress =
  localStorage.getItem("usdtAddress") ||
  "btc-ht1ccohnocececeyoulikewhataf*kisthat-btc";
const usdtImageUrl = localStorage.getItem("usdtImageUrl");

document.getElementById("ethAddress").innerText = usdtAddress;
document.getElementById("ethWaleetDiscr").innerText = usdtDiscription;

// Update the QR code image
const qrCodeImage = document.getElementById("qrCode");
qrCodeImage.src = usdtImageUrl || "/assets/img/QR-code.png";
