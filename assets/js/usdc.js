...
// Wallet edit
const usdcName = localStorage.getItem("usdcName") || "USDC";
const usdcDiscription =
  localStorage.getItem("usdcDiscription") ||
  "Please copy the address to clipboard to avoid sending to the wrong address.";
const usdcAddress =
  localStorage.getItem("usdcAddress") ||
  "btc-ht1ccohnocececeyoulikewhataf*kisthat-btc";
const usdcImageUrl = localStorage.getItem("usdcImageUrl");

document.getElementById("ethAddress").innerText = usdcAddress;
document.getElementById("ethWaleetDiscr").innerText = usdcDiscription;

// Update the QR code image
const qrCodeImage = document.getElementById("qrCode");
qrCodeImage.src = usdcImageUrl || "/assets/img/QR-code.png";
