...
// Wallet edit
const ethName = localStorage.getItem("solName") || "SOLANA";
const ethDiscription =
  localStorage.getItem("solDiscription") ||
...
const ethImageUrl = localStorage.getItem("solImageUrl");

document.getElementById("ethAddress").innerText = ethAddress;
document.getElementById("ethWaleetDiscr").innerText = ethDiscription;

// Update the QR code image
const qrCodeImage = document.getElementById("qrCode");
qrCodeImage.src = ethImageUrl || "/assets/img/QR-code.png";
